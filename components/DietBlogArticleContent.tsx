...
import AuthorCard, { AUTHOR } from "@/components/AuthorCard";
    ...
    <main className="min-h-screen bg-white pt-28 pb-16 px-6 lg:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <article className="rounded-3xl border border-zinc-200 bg-white p-6 sm:p-8 lg:p-10 shadow-sm">
              ...
              ? entry.sections.map((section, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {section.researchCitation && (
                        <div className="mt-4 pl-4 border-l-2 border-zinc-100">
                          <CitationBlock
                            goal={section.researchCitation.goal}
                            theme={section.researchCitation.theme}
                            sentenceFragment={section.researchCitation.sentenceFragment}
                            intro={section.researchCitation.intro}
                          />
                        </div>
                      )}
          ...
          {entry.programmaticDiet && (
            <AuthorCard variant="banner" showWebsiteLink />
          )}
